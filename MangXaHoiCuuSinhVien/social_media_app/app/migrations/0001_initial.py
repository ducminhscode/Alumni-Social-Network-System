# Generated by Django 5.1.2 on 2025-01-08 15:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', cloudinary.models.CloudinaryField(default='https://res.cloudinary.com/dqw4mc8dg/image/upload/v1736348093/aj6sc6isvelwkotlo1vw_zxmebm.png', max_length=255, verbose_name='avatar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_survey', models.IntegerField(choices=[(1, 'Training program'), (2, 'Recruitment information'), (3, 'Income'), (4, 'Employment situation')], default=1)),
            ],
        ),
        migrations.CreateModel(
            name='Alumni',
            fields=[
                ...
                ('status', models.CharField(choices=[(1, 'Pending'), (2, 'Confirmed'), (3, 'Rejected')], default=1, max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.surveyquestiontype'),
        ),
        migrations.CreateModel(
            name='InvitationPost',
            fields=[
                ...
                ('invitation_users', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
